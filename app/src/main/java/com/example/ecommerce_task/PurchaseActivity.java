...
import com.example.ecommerce_task.Order.Order;
import com.example.ecommerce_task.Order.OrderAdapter;
import com.example.ecommerce_task.Order.OrderItem;
...
public class PurchaseActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        List<OrderItem> orders = Ordermanager.getInstance(this).getOrders();
